data:extend({
	{
		...
		icon = biorev.GRAPHICS .. "/icons/items/apple-crop.png",
		icon_size = 64,
	...
	},
	{
		type = "item",
		name = "br-apple-tree",
		stack_size = biorev.STACKSIZE.TREE,
	...
	},
	{
		...
		name = "br-orange-crop",
		stack_size = biorev.STACKSIZE.CROP,
		icon = biorev.GRAPHICS .. "/icons/items/orange-crop.png",
		icon_size = 64,
		subgroup = "br-agriculture-trees",
	},
	{
	...
	},
	{
		...
		name = "br-mango-crop",
		stack_size = biorev.STACKSIZE.CROP,
		icon = biorev.GRAPHICS .. "/icons/items/mango-crop.png",
		icon_size = 64,
		subgroup = "br-agriculture-trees",
	},
	{
	...
	},
	{
		...
		name = "br-walnut-crop",
		stack_size = biorev.STACKSIZE.CROP,
		icon = biorev.GRAPHICS .. "/icons/items/walnut-crop.png",
		icon_size = 64,
		subgroup = "br-agriculture-trees",
	},
	{
