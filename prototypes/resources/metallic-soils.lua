...
data.raw.planet["nauvis"].map_gen_settings.autoplace_settings.entity.settings["br-metallic-soil"] = {}

data:extend({
	{
		type = "resource",
		name = "br-metallic-soil",
		icon = biorev.GRAPHICS .. "/icons/items/metallic-soil.png",
		icon_size = 64,
		...
		minable = {
			mining_time = 1,
			result = "br-metallic-soil",
		},
		collision_box = { { -0.1, -0.1 }, { 0.1, 0.1 } },
		selection_box = { { -0.5, -0.5 }, { 0.5, 0.5 } },
		autoplace = resource_autoplace.resource_autoplace_settings({
			name = "br-peat",
			patch_set_name = "br-metallic-soil",
			order = "b",
		...
		stages = {
			sheet = {
				filename = biorev.GRAPHICS .. "/resources/metallic-soil.png",
				priority = "extra-high",
				size = 64,
				frame_count = 1,
				variation_count = 1,
		...
		map_color = { 100 / 255, 50 / 255, 25 / 255 },
	},
	-- {
	-- 	type = "resource",
	-- 	name = "br-ferric-soil",
